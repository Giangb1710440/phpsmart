    ...
    <div class="table-responsive">
        <form action="{{route('checkout_vnpay')}}" id="create_form" method="post">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" cols="20" id="order_desc" name="order_desc" rows="2">Thanh toan hoa don</textarea>
            </div>
            <div class="form-group">
            ...
            <button type="submit" name="redirect" id="redirect" onclick="history.back()" class="btn btn-default">Trở về</button>
